  ...
  Future _onCreate(Database db, int version) async {
    ...
    await db.execute('''
      CREATE TABLE measurementscoll (
        ...
        maxled1 REAL NOT NULL,
        maxled2 REAL NOT NULL,
        maxled3 REAL NOT NULL,
        maxled4 REAL NOT NULL,
        minled1 REAL NOT NULL,
        minled2 REAL NOT NULL,
        minled3 REAL NOT NULL,
        minled4 REAL NOT NULL,
        m1_4p REAL NOT NULL,
        m2_4p REAL NOT NULL,
        m3_4p REAL NOT NULL,
        m4_4p REAL NOT NULL,
        ...
        m25_4p REAL NOT NULL,
        m26_4p REAL NOT NULL,
        m27_4p REAL NOT NULL,
        m28_4p REAL NOT NULL,
        m29_4p REAL NOT NULL,
        m30_4p REAL NOT NULL,
        m31_4p REAL NOT NULL,
        m32_4p REAL NOT NULL,
        f1_4p REAL NOT NULL,
        f2_4p REAL NOT NULL,
        f3_4p REAL NOT NULL,
        f4_4p REAL NOT NULL,
        ...
        f25_4p REAL NOT NULL,
        f26_4p REAL NOT NULL,
        f27_4p REAL NOT NULL,
        f28_4p REAL NOT NULL,
        f29_4p REAL NOT NULL,
        f30_4p REAL NOT NULL,
        f31_4p REAL NOT NULL,
        f32_4p REAL NOT NULL,
        m1_2p REAL NOT NULL,
        m2_2p REAL NOT NULL,
        m3_2p REAL NOT NULL,
        m4_2p REAL NOT NULL,
        ...
        m8_2p REAL NOT NULL,
        m9_2p REAL NOT NULL,
        m10_2p REAL NOT NULL,
        m11_2p REAL NOT NULL,
        m12_2p REAL NOT NULL,
        m13_2p REAL NOT NULL,
        m14_2p REAL NOT NULL,
        m15_2p REAL NOT NULL,
        m16_2p REAL NOT NULL,
        m17_2p REAL NOT NULL,
        m18_2p REAL NOT NULL,
        m19_2p REAL NOT NULL,
        m20_2p REAL NOT NULL,
        m21_2p REAL NOT NULL,
        m22_2p REAL NOT NULL,
        m23_2p REAL NOT NULL,
        m24_2p REAL NOT NULL,
        m25_2p REAL NOT NULL,
        m26_2p REAL NOT NULL,
        m27_2p REAL NOT NULL,
        m28_2p REAL NOT NULL,
        m29_2p REAL NOT NULL,
        m30_2p REAL NOT NULL,
        m31_2p REAL NOT NULL,
        m32_2p REAL NOT NULL,
        f1_2p REAL NOT NULL,
        f2_2p REAL NOT NULL,
        f3_2p REAL NOT NULL,
        f4_2p REAL NOT NULL,
        ...
        f8_2p REAL NOT NULL,
        f9_2p REAL NOT NULL,
        f10_2p REAL NOT NULL,
        f11_2p REAL NOT NULL,
        f12_2p REAL NOT NULL,
        f13_2p REAL NOT NULL,
        f14_2p REAL NOT NULL,
        f15_2p REAL NOT NULL,
        f16_2p REAL NOT NULL,
        f17_2p REAL NOT NULL,
        f18_2p REAL NOT NULL,
        f19_2p REAL NOT NULL,
        f20_2p REAL NOT NULL,
        f21_2p REAL NOT NULL,
        f22_2p REAL NOT NULL,
        f23_2p REAL NOT NULL,
        f24_2p REAL NOT NULL,
        f25_2p REAL NOT NULL,
        f26_2p REAL NOT NULL,
        f27_2p REAL NOT NULL,
        f28_2p REAL NOT NULL,
        f29_2p REAL NOT NULL,
        f30_2p REAL NOT NULL,
        f31_2p REAL NOT NULL,
        f32_2p REAL NOT NULL,
        date DATE NOT NULL,
        iduser INTEGER NOT NULL REFERENCES users(iduser) ON UPDATE CASCADE ON DELETE CASCADE
      );
    ''');
