...
class DevBTLE extends StatefulWidget {
  const DevBTLE({Key? key}) : super(key: key);

  @override
  State<DevBTLE> createState() => _FlutterBlueAppState();
}

class _FlutterBlueAppState extends State<DevBTLE> {
      ...
      TextButton(
          ...
          child: Text(
            ...
            style: Theme.of(context)
                .primaryTextTheme
                .labelLarge
                // ?.copyWith(color: Colors.white), // ALT
...
class _CharacteristicTileState extends State<CharacteristicTile> {
  ...
  List<int> _getRandomBytes() {
    return utf8.encode('@atu').toList(); // ALT
    // final math = Random();
    // return [
    //   math.nextInt(255),
    //   math.nextInt(255),
